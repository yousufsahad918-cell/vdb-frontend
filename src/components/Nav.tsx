                ...
                <div key={group.brand} style={{ marginBottom: 6 }}>
                  ...
                  >
                    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                      ...
                      <span style={{ fontFamily: "var(--font-display)", fontWeight: 800, fontSize: "0.9rem", color: expandedBrand === group.brand ? group.color : "var(--white)" }}>
                        {group.brand}
                      </span>
                      <span style={{ fontSize: "0.7rem", color: "var(--muted)", background: "var(--bg-2)", borderRadius: 20, padding: "2px 8px" }}>
                        {group.items.length}
                      </span>
                    </div>

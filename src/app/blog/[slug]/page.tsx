  ...
  return (
    <main style={{ minHeight: "100vh", background: "var(--bg)", paddingBottom: 80 }}>
      ...
      <div style={{
        ...
        <a href="/#products"
          style={{ display: "flex", alignItems: "center", justifyContent: "center", width: 48, height: 48, background: "var(--orange)", borderRadius: "50%", boxShadow: "0 4px 16px rgba(255,92,0,0.4)", textDecoration: "none" }}
          title="Shop Now"
        >

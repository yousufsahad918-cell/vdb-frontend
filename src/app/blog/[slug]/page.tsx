  ...
  return (
    <main style={{ minHeight: "100vh", background: "var(--bg)", paddingBottom: 80 }}>
      ...
      <header style={{ maxWidth: 760, margin: "0 auto", padding: "28px 20px 0" }}>
        ...
        <div style={{ marginBottom: 28, background: "var(--bg-2)", border: "1px solid var(--border)", borderRadius: 16, padding: "18px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
            ...
            <a href="https://wa.me/919074445985?text=Hi%20VapeDeliveryBangalore%2C%20I%20want%20to%20order%20a%20vape%20in%20Bangalore" target="_blank" rel="noopener noreferrer" style={{ display: "block", background: "#25D366", color: "#fff", textAlign: "center" as const, padding: "10px", borderRadius: 10, fontWeight: 700, fontSize: "0.82rem", textDecoration: "none" }}>Order on WhatsApp</a>
          </div>
        </div>
      ...
      <div style={{
        ...
        <a href="https://wa.me/919074445985?text=Hi%20VapeDeliveryBangalore%2C%20I%20want%20to%20order%20a%20vape%20in%20Bangalore"

...
export const metadata: Metadata = {
  title: "Lost Mary Bangalore — Buy Lost Mary Vapes | 30 Min Delivery | VapeDeliveryBangalore.com",
  description: "Buy Lost Mary vapes in Bangalore with 30 min delivery. Lost Mary MT35000 Turbo, MO10000 and more. 100% original.",
  alternates: { canonical: "https://vapedeliverybangalore.com/lost-mary-bangalore" },
};

const filtered = products.filter((p: any) => {
  const slug = "lost-mary-bangalore";
    ...
    <main style={{ minHeight: "100vh", background: "#f6faf7", paddingBottom: 80 }}>
      <div style={{ background: "#14532d", padding: "32px 16px 24px" }}>
        <div style={{ maxWidth: 700, margin: "0 auto" }}>
          ...
          <h1 style={{ color: "#fff", fontSize: "1.8rem", fontWeight: 900, marginBottom: 8 }}>LOST MARY BANGALORE</h1>
          <p style={{ color: "rgba(255,255,255,0.85)", fontSize: "0.88rem", lineHeight: 1.6 }}>Buy 100% original Lost Mary vapes in Bangalore with 30 minute delivery. Lost Mary MT35000 Turbo and MO10000 available. Fast delivery across all Bangalore areas. Order on WhatsApp.</p>
        </div>
      </div>
      <div style={{ maxWidth: 700, margin: "0 auto", padding: "24px 16px" }}>
        <a href={`https://wa.me/919074445985?text=Hi%2C%20I%20want%20to%20order%20Lost%20Mary%20vape%20in%20Bangalore.%20Please%20confirm%20availability.`}

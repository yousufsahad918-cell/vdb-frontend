...
export default function Page() {
  const filtered = products.filter(p => p.brand === "Lost Mary");
    ...
    <main style={{ minHeight: "100vh", background: "#f6faf7", paddingBottom: 80 }}>
      <div style={{ background: "#14532d", padding: "32px 16px 24px" }}>
        <div style={{ maxWidth: 700, margin: "0 auto" }}>
          ...
          <p style={{ color: "rgba(255,255,255,0.85)", fontSize: "0.88rem", lineHeight: 1.6 }}>Buy 100% original Lost Mary vapes in Bangalore with 30 minute delivery. MT35000 Turbo and MO10000 available. Order on WhatsApp.</p>
        </div>
      </div>

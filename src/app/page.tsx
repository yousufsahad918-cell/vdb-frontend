...
import { locations, WHATSAPP_URL, SHOP_URL } from "@/lib/locations";
...
const FEATURES = [
  {
    ...
    desc: "We dispatch fast. Most orders across Bangalore reach you within the hour.",
  },
  {
    icon: "🔒",
    title: "100% Discreet",
    desc: "Plain packaging, no labels. Your order is your business.",
  },
  {
    icon: "🗺️",
    title: "20+ Areas Covered",
    desc: "From Whitefield to Rajajinagar, Electronic City to Yelahanka — we cover all of Bangalore.",
  },
  {
    icon: "💬",
    title: "Order via WhatsApp",
    desc: "No app download, no login. Just message us and we'll handle the rest.",
  },
  {
    icon: "🌿",
    title: "Best Flavours",
    desc: "Disposable vapes, pod systems, and e-liquids from top brands — huge selection available.",
  },
  {
    icon: "✅",
    title: "Trusted by 1000+",
    desc: "Hundreds of repeat customers across Bangalore trust us for reliable vape delivery.",
  },
];
    ...
    <>
      ...
      <section className="hero">
        <div className="container">
          ...
          <p className="hero-sub">
            Order vape online in Bangalore and get it delivered in 20–30
            minutes. Disposable vapes, pod systems & e-liquids — discreet
            delivery to BTM, HSR, Koramangala, Whitefield & 20+ areas.
          </p>
      ...
      <section className="section">
        <div className="container">
          ...
          <p>
            ...
            and deliver across all major Bangalore neighbourhoods, fast and
            discreetly.
          </p>
          <p>
      ...
      <section className="section">
        <div className="container">
          ...
          <p>
            Fast, discreet, and reliable — here's why Bangalore trusts us for
            vape delivery.
          </p>
      ...
      <section className="cta-section">
        <div className="container">
          ...
          <p>
            Message us on WhatsApp — we'll confirm your order and dispatch
            within minutes.
          </p>

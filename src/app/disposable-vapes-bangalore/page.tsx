...
export default function Page() {
  const filtered = products.filter(p => p.category === "Disposable");
  ...
  return (
    <main style={{ minHeight: "100vh", background: "#f6faf7", paddingBottom: 80 }}>
      ...
      <div style={{ maxWidth: 700, margin: "0 auto", padding: "24px 16px" }}>
        <a href={`https://wa.me/916282878843?text=Hi%2C%20I%20want%20to%20order%20disposable%20vape%20in%20Bangalore.%20Please%20confirm%20availability.`}

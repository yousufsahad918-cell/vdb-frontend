...
export const metadata: Metadata = {
  title: "ZYN Bangalore — Buy ZYN Nicotine Pouches | 30 Min Delivery | VapeDeliveryBangalore.com",
  description: "Buy ZYN nicotine pouches in Bangalore with 30 min delivery. ZYN Cool Mint. Tobacco-free. 100% original.",
  alternates: { canonical: "https://vapedeliverybangalore.com/zyn-bangalore" },
};

const filtered = products.filter((p: any) => {
  const slug = "zyn-bangalore";
    ...
    <main style={{ minHeight: "100vh", background: "#f6faf7", paddingBottom: 80 }}>
      <div style={{ background: "#14532d", padding: "32px 16px 24px" }}>
        <div style={{ maxWidth: 700, margin: "0 auto" }}>
          ...
          <h1 style={{ color: "#fff", fontSize: "1.8rem", fontWeight: 900, marginBottom: 8 }}>ZYN BANGALORE</h1>
          <p style={{ color: "rgba(255,255,255,0.85)", fontSize: "0.88rem", lineHeight: 1.6 }}>Buy ZYN nicotine pouches in Bangalore with 30 minute delivery. Tobacco-free, smoke-free and discreet. Use anywhere — offices, flights, restaurants. Order on WhatsApp.</p>
        </div>
      </div>
      <div style={{ maxWidth: 700, margin: "0 auto", padding: "24px 16px" }}>
        <a href={`https://wa.me/919074445985?text=Hi%2C%20I%20want%20to%20order%20ZYN%20nicotine%20pouches%20in%20Bangalore.%20Please%20confirm%20availability.`}

...
const filtered = products.filter((p: any) => {
  const slug = "nicotine-pouches-bangalore";
    ...
    <main style={{ minHeight: "100vh", background: "#f6faf7", paddingBottom: 80 }}>
      <div style={{ background: "#14532d", padding: "32px 16px 24px" }}>
        <div style={{ maxWidth: 700, margin: "0 auto" }}>
          ...
          <p style={{ color: "rgba(255,255,255,0.85)", fontSize: "0.88rem", lineHeight: 1.6 }}>Buy nicotine pouches in Bangalore with 30 minute delivery. ZYN and Velo — tobacco-free, smoke-free and completely discreet. Use anywhere in Bangalore. Order on WhatsApp.</p>
        </div>
      </div>
      <div style={{ maxWidth: 700, margin: "0 auto", padding: "24px 16px" }}>
        <a href={`https://wa.me/919074445985?text=Hi%2C%20I%20want%20to%20order%20nicotine%20pouches%20in%20Bangalore.%20Please%20confirm%20availability.`}

...
export const metadata: Metadata = {
  title: "Elfbar Bangalore — Buy Elfbar Vapes | 30 Min Delivery | VapeDeliveryBangalore.com",
  description: "Buy Elfbar vapes in Bangalore with 30 min delivery. Elfbar Raya D1, MoonNight 40K, Ice King and more. 100% original.",
  alternates: { canonical: "https://vapedeliverybangalore.com/elfbar-bangalore" },
};

const filtered = products.filter((p: any) => {
  const slug = "elfbar-bangalore";
    ...
    <main style={{ minHeight: "100vh", background: "#f6faf7", paddingBottom: 80 }}>
      <div style={{ background: "#14532d", padding: "32px 16px 24px" }}>
        <div style={{ maxWidth: 700, margin: "0 auto" }}>
          ...
          <h1 style={{ color: "#fff", fontSize: "1.8rem", fontWeight: 900, marginBottom: 8 }}>ELFBAR BANGALORE</h1>
          <p style={{ color: "rgba(255,255,255,0.85)", fontSize: "0.88rem", lineHeight: 1.6 }}>Buy 100% original Elfbar vapes in Bangalore with 30 minute delivery. Full Elfbar range — Raya D1, MoonNight 40K, Raya D3, Ice King, BC10000 and more. Order on WhatsApp.</p>
        </div>
      </div>

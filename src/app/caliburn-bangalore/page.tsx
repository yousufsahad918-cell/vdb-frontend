...
export default function Page() {
  const filtered = products.filter(p => p.brand === "Caliburn");
    ...
    <main style={{ minHeight: "100vh", background: "#f6faf7", paddingBottom: 80 }}>
      <div style={{ background: "#14532d", padding: "32px 16px 24px" }}>
        <div style={{ maxWidth: 700, margin: "0 auto" }}>
          ...
          <p style={{ color: "rgba(255,255,255,0.85)", fontSize: "0.88rem", lineHeight: 1.6 }}>Buy 100% original Caliburn pod systems in Bangalore with 30 minute delivery. Full Uwell range available. Order on WhatsApp.</p>
        </div>
      </div>
      <div style={{ maxWidth: 700, margin: "0 auto", padding: "24px 16px" }}>
        <a href={`https://wa.me/916282878843?text=Hi%2C%20I%20want%20to%20order%20Caliburn%20pod%20system%20in%20Bangalore.%20Please%20confirm%20availability.`}

...
export const metadata: Metadata = {
  title: "Caliburn Bangalore — Buy Caliburn Pod Systems | 30 Min Delivery | VapeDeliveryBangalore.com",
  description: "Buy Caliburn pod systems in Bangalore with 30 min delivery. Caliburn G4, G4 Pro, G5 Lite and more. 100% original Uwell.",
  alternates: { canonical: "https://vapedeliverybangalore.com/caliburn-bangalore" },
};

const filtered = products.filter((p: any) => {
  const slug = "caliburn-bangalore";
    ...
    <main style={{ minHeight: "100vh", background: "#f6faf7", paddingBottom: 80 }}>
      <div style={{ background: "#14532d", padding: "32px 16px 24px" }}>
        <div style={{ maxWidth: 700, margin: "0 auto" }}>
          ...
          <h1 style={{ color: "#fff", fontSize: "1.8rem", fontWeight: 900, marginBottom: 8 }}>CALIBURN BANGALORE</h1>
          <p style={{ color: "rgba(255,255,255,0.85)", fontSize: "0.88rem", lineHeight: 1.6 }}>Buy 100% original Caliburn pod systems in Bangalore with 30 minute delivery. Full Uwell Caliburn range — G4, G4 Pro, G4 Mini, G5 Lite, A2 and more. Order on WhatsApp.</p>
        </div>
      </div>
      <div style={{ maxWidth: 700, margin: "0 auto", padding: "24px 16px" }}>
        <a href={`https://wa.me/919074445985?text=Hi%2C%20I%20want%20to%20order%20Caliburn%20pod%20system%20in%20Bangalore.%20Please%20confirm%20availability.`}

...
const WA_LINK = `https://wa.me/919074445985?text=Hi%2C%20I%20want%20to%20order%20a%20vape%20in%20Bangalore.%20Please%20confirm%20availability`;
...
export const blogPosts: BlogPost[] = [
  // ─── CLUSTER 1: IT / TECH PARK ────────────────────────────────────────────
  {
    ...
    metaTitle: "Vape Delivery in Whitefield IT Corridor | VapeDeliveryBangalore.com",
...
${CTA()}`,
...

  {
    ...
    metaTitle: "Vape Delivery Electronic City Bangalore | VapeDeliveryBangalore.com",
...
${CTA()}`,
...

  {
    ...
    metaTitle: "Vape Delivery Manyata Tech Park Hebbal | VapeDeliveryBangalore.com",
...
${CTA()}`,
  ...
  // ─── CLUSTER 2: RESIDENTIAL SOUTH BANGALORE ───────────────────────────────
  {
    ...
    metaTitle: "Vape Delivery South Bangalore — BTM HSR Jayanagar | VapeDeliveryBangalore.com",
...
${CTA()}`,
...

  {
    ...
    metaTitle: "Vape Delivery Koramangala Indiranagar Bangalore | VapeDeliveryBangalore.com",
...
${CTA()}`,
...

  {
    ...
    metaTitle: "Vape Delivery Rajajinagar Malleshwaram West Bangalore | VapeDeliveryBangalore.com",
...
${CTA()}`,
  ...
  // ─── CLUSTER 3: STUDENT AREAS ─────────────────────────────────────────────
  {
    ...
    metaTitle: "Buy Vape Near Colleges Bangalore — Beginner Guide | VapeDeliveryBangalore.com",
...
${CTA()}`,
...

  {
    ...
    metaTitle: "Vape Delivery MG Road Brigade Road Bangalore | VapeDeliveryBangalore.com",
...
${CTA()}`,
  ...
  // ─── CLUSTER 4: INTENT / PRODUCT BLOGS ───────────────────────────────────
  {
    ...
    metaTitle: "Vapes in Bangalore — Buy Online with Fast Delivery | VapeDeliveryBangalore.com",
...
${CTA()}`,
...

  {
    ...
    metaTitle: "Best Disposable Vapes Bangalore 2025 | VapeDeliveryBangalore.com",
...
${CTA()}`,
  ...
  // ─── NEW: ELFBAR BANGALORE ────────────────────────────────────────────────
  {
    ...
    metaTitle: "Buy Elfbar in Bangalore | Raya D1, D3, Ice King | VapeDeliveryBangalore",
...
<h2>Why Buy Elfbar from VapeDeliveryBangalore?</h2>
...
${CTA()}`,
  ...
  // ─── NEW: CALIBURN POD DEVICE BANGALORE ──────────────────────────────────
  {
    ...
    metaTitle: "Buy Caliburn Pod Device in Bangalore | G4, G5, KOKO | VapeDeliveryBangalore",
...
${CTA()}`,
  ...
  // ─── NEW: NICOTINE POUCHES BANGALORE ─────────────────────────────────────
  {
    ...
    metaTitle: "Buy Nicotine Pouches in Bangalore | ZYN Cool Mint, Velo | VapeDeliveryBangalore",
...
${CTA()}`,
  ...
  // ─── D3 PRO RAISING ISSUES WARNING ───────────────────────────────────────
  {
    ...
    metaTitle: "Elfbar D3 Pro Issues Bangalore — Read Before Buying | VapeDeliveryBangalore",
...
${CTA()}`,
  ...
  // ─── BEST VAPE FOR BEGINNERS BANGALORE ───────────────────────────────────
  {
    ...
    metaTitle: "Best Vape for Beginners Bangalore 2025 | Starter Guide | VapeDeliveryBangalore",
...
${CTA()}`,
  ...
  // ─── VAPE VS CIGARETTE BANGALORE ─────────────────────────────────────────
  {
    ...
    metaTitle: "Vaping vs Smoking Cigarettes Bangalore | Switch Guide | VapeDeliveryBangalore",
